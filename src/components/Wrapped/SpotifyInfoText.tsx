  ...
  return (
    <WrappedContainer bg="bg-zinc-900" text="text-starship-400">
      ...
      <MutedText className="!text-zinc-200 max-w-xl mx-auto">
        Discord Wrapped can play fitting songs during your Wrapped using the
        Spotify Player.
        <br />
        <br />
        If you have Spotify Premium, simply log in to your Spotify in your
        browser - no need to connect your account to Discord Wrapped! Discord
        Wrapped won't have access to your Spotify data, but simply embed the
        Spotify Player.
        <br />
        <br />
        If you don't have Spotify Premium, you can still fully use Discord
        Wrapped - just without the music.
      </MutedText>

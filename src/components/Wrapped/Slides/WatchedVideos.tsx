...
const commentsOnVideos = {
  ...
  1000: "A light user, I see",
  10000: "You're definitely getting your chat time in!",
  15000: "Your attention span is probably slowly degrading, right?",
  25000: "Discord addict in the making.",
  30000:
    "You've surpassed the average user's Discord activity - so there's that",
  35000: "Discord is your second home now, isn't it?",
  40000: "Your fingers must be getting tired from all that typing.",
  50000: "Might wanna get some fresh air, huh?",
  60000: "You've reached a new level of Discord obsession.",
  75000: "There's a whole world outside Discord, you know?",
  ...
  200000: "Congratulations, you've completed Discord - maybe go outside next?",
};
  ...
  return (
    <WrappedContainer bg="bg-zinc-900" text="text-starship-400">
      <InfoText className="!text-zinc-200">
        Since {dayjs(firstWatchedVideo).format("L")} you've sent
      </InfoText>

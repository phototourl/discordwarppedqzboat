...
function Terms() {
  return (
    <LegalPage>
      <Head>
        <title>Discord Wrapped - Terms of Service</title>
      ...
      <div className="mx-auto max-w-lg">
        ...
        <p>
          These terms of service ("Terms") govern your access and use of Discord
          Wrapped ("Service"), a web application that provides personalized
          statistics on your Discord usage. The Service is provided by Discord
          Wrapped LLC ("we", "us" or "our").
        </p>
        <p>
        ...
        <p>
          The Service relies on data from Discord's API and other third-party

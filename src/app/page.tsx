...
function DiscordWrappedAppPage() {
    ...
    <div>
      ...
      {page === "error" && (
        <WrappedContainer>
          ...
          <MutedText>
            We couldn't read your Discord data export. Please make sure you
      ...
      {page === "possibly_empty" && (
        <WrappedContainer>
          ...
          <MutedText className="mx-auto max-w-xl">
            The Discord data export you uploaded doesn't contain any data about
            messages or activity. This might be because of your privacy settings
            in Discord. While we can still show you some statistics, data about
            your activity history will be blank.
            <br />
      ...
      {page === "text" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            file format when requesting your Discord data export. Unfortunately,
            Discord Wrapped does not support this format yet as it cannot
      ...
      {page === "unknown_file" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            Machine-readable" as the file format when requesting your Discord
            data export.
            <br />
            If you modified the file, make sure your file has the correct file
            extension.
      ...
      {page === "demo" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-xl mx-auto">
            You can view a demo of Discord Wrapped with sample data if you
            want to.
            <br />
            <strong>
              This is NOT your Wrapped, but a demo of what it could look like.
              <br />
              It does not use your Discord data export.
            </strong>
            <br />
            <br />
            The data is randomly generated and does not represent any real
            Discord user - if you want to see your own Wrapped, you can reload
        ...
        <WrappedContainer>
          ...
          <HideForTime time={15000}>
            <MutedText className="text-sm text-center">
              ...
              <br />
              the page and uploading your Discord data export again.
            </MutedText>
          </HideForTime>
        </WrappedContainer>
      )}
      ...
      {page === "play" && wrapped?.demoMode && (
        <div className="fixed bottom-12 left-12 right-12 z-0 opacity-60 text-zinc-500 break-words">
          ...
          <p className="text-sm">
            This is a demo of Discord Wrapped. It does not use your real
            Discord data.
            <br />
            To see your own Wrapped, reload the page and upload your Discord
            data.
          </p>
        </div>
      )}
...
export default DiscordWrappedAppPage;
